...
public class LastProductsFragment extends Fragment implements ProductsAdapter.AdapterListener {

    @BindView(R.id.lastProductRV)
    RecyclerView lastProductRV;
    private LastProductsViewModel mViewModel;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        return inflater.inflate(R.layout.last_products_fragment, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        mViewModel = ViewModelProviders.of(this).get(LastProductsViewModel.class);
        mAdapter = new ProductsAdapter();
        mAdapter.mListener = this;
        lastProductRV.setAdapter(mAdapter);
        lastProductRV.addOnScrollListener(getScrollListener());
        subscribeObserver();
