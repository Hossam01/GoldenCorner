...
public class HomeCategoriesAdapter extends RecyclerView.Adapter<HomeCategoriesAdapter.CategoriesHolder> {
    ...
    public class CategoriesHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        @BindView(R.id.categoriesIV)
        ImageView categoriesIV;
        ...
        public void onClick(View v) {
            if (mListener != null)
                mListener.onCategoriesClicked(dataList.get(getAdapterPosition()));
        }
    }
    ...
    public interface AdapterListener {
        void onCategoriesClicked(Category record);
    }
}
